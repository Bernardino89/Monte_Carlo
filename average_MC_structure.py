...
# The program allows obtaining an average structure generated by LAMMPS, the output file in z-matrix format
...
#print 'leng atom list=', len(atoms)
#print "bond list=", bond
#print "b=", b 
#print 'leng bond list',len(b)
#print "angle list=", angle
#print "a=", a
#print 'leng angle list=',len(a)
#print "dihedral=", dihedral
#print "d=", d 
#print 'leng dihedral list=',len(d)
...
##################################################################################################
#
#  questo mi fa la somma solo sulla prima lunghezza di legame
#
#jump1=jump-1
#total = 0
...
######### cut atom, bond, angle and dihedral lists #########################
...
#block=[ [Atoms,Bon,nb,An, na,Dh, nd],[,Y2,Z2], [X3,Y3,Z3], [X4,Y4,Z4], ]


#print(["%s %s"%(a,b)"\n" for a,b in zip(Atoms,Bon)])


#print jump
#print 'average configuration from Monte Carlo' 
#block=[ [Atoms],[Bon],[nb],[An], [na],[Dh], [nd], ]
